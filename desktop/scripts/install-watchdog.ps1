# D1.2 — install Task Scheduler watchdog for WPF Agent (every 2 minutes, current user)
# Run once (re-run after path changes):
...
$taskName = "BV87-WPF-Agent-Watchdog"
...
Write-Host "Also run install-agent-autostart.ps1 so Agent starts at Windows logon."
