...
public sealed class AttendanceAuditLogViewModel : ViewModelBase
{
    ...
    public AttendanceAuditLogViewModel(AdminApiClient adminApi)
    {
        _adminApi = adminApi;
        ...
        Items = new ObservableCollection<AttendanceAuditLogRowViewModel>();
    ...
    public ObservableCollection<AttendanceAuditLogRowViewModel> Items { get; }
    ...
    public string PageTitle => UtilitiesUiStrings.AuditLog.PageTitle;
    public string PageSubtitle => UtilitiesUiStrings.AuditLog.PageSubtitle;
    public string ListTitle => UtilitiesUiStrings.AuditLog.ListTitle;
    public string FilterRangeLabel => UtilitiesUiStrings.AuditLog.FilterRange;
    public string EmptyMessage => UtilitiesUiStrings.AuditLog.Empty;
    public string LoadingMessage => UtilitiesUiStrings.Loading;
    public string UnitLabel => UtilitiesUiStrings.AuditLog.UnitLabel;
    ...
    private async Task LoadAsync(bool force)
    {
        ...
        try
        {
            var data = await _adminApi.GetAttendanceAuditLogsAsync(
                _appliedFrom,
                _appliedTo,
                _appliedDeptFilter,
                _currentPage,
            ...
            Items.Clear();
            var rows = (data.Items ?? []).Select(item => new AttendanceAuditLogRowViewModel(item)).ToList();
