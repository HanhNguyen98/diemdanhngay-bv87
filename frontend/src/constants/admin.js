export const ADMIN_UI = {
  ...
  logout: 'Đăng xuất',
  footer: {
    copyright: '© 2026 BỆNH VIỆN QUÂN Y 87 — Bệnh viện Quân y 87 | Chương trình chấm công phát triển bởi Tham mưu - Hành chính',
  ...
  dashboard: {
    ...
    fillTimesHint:
      'Chỉ nhập ô đang trống. Giờ đã có từ máy quét không bị ghi đè. Status ĐI LÀM / ĐI TRỄ giữ nguyên hoặc tự gán theo giờ vào (trước/sau 07:00).',
    ...
    fillTimesPreviewRuleC: (hm) => `Dựa trên giờ vào: ${hm} (mốc đi trễ: 07:00)`,
