export const ADMIN_UI = {
  ...
  searchPlaceholder: 'Tìm Đơn vị, Nhân viên...',
  searchPlaceholderStaff: 'Tìm nhân viên theo tên...',
  searchPlaceholderDepartments: 'Tìm theo tên, mã, trưởng đơn vị...',
  support: 'Hỗ trợ',
  logout: 'Đăng xuất',
  footer: {
    copyright: '© 2026 Bệnh viện Quân y 87  — Chương trình chấm công phát triển bởi Tham mưu - Hành chính',
  ...
  dashboard: {
    ...
    progressActionsMenu: 'Quản lý',
    progressActionsMenuAria: 'Quản lý khóa sổ và quyền chỉnh sửa HEAD',
    menuActionLockDept: 'Khóa sổ',
    menuActionUnlockDept: 'Mở khóa sổ',
    menuActionBlockHeadEdit: 'Khóa chỉnh sửa HEAD',
    menuActionUnblockHeadEdit: 'Mở chỉnh sửa HEAD',
    menuActionLegacyReport: 'Đã nộp báo cáo (cũ)',
    reportStatusBlocked: 'HEAD đang bị khóa chỉnh sửa — bấm để mở',
    reportStatusOpen: 'HEAD được chỉnh sửa — bấm để khóa',
    reportStatusSubmitted: 'Lịch sử đã nộp báo cáo (cũ) — không đổi được',
    ...
    actionBlockHeadEdit: 'Khóa chỉnh sửa HEAD',
    actionUnblockHeadEdit: 'Mở chỉnh sửa HEAD',
    blockReportReason: 'Khóa chỉnh sửa HEAD từ bảng điều khiển',
    ...
    reminderStatsOthers: (deptCount) => `Khác (${deptCount} đơn vị)`,
    reminderStatsCenterLabel: 'lần nhắc',
    reminderStatsDetailHint: 'Chi tiết đủ mọi đơn vị: bảng Chi tiết / Xuất Excel',
    ...
    attendanceAuditTitle: 'Lịch sử Chấm công',
    attendanceAuditListTitle: 'CHI TIẾT',
    attendanceAuditFilterRange: 'Thời gian thao tác',
    attendanceAuditColTime: 'THỜI GIAN',
    attendanceAuditColUser: 'TÀI KHOẢN',
    attendanceAuditColDept: 'ĐƠN VỊ',
    attendanceAuditColEmp: 'NHÂN VIÊN',
    attendanceAuditColDate: 'NGÀY CÔNG',
    attendanceAuditColAction: 'HÀNH ĐỘNG',
    attendanceAuditColIp: 'IP',
    attendanceAuditEmpty: 'Không có dữ liệu!',
    attendanceAuditUnit: 'thao tác',
    unlockRequestsTitle: 'Yêu cầu mở khóa',
    unlockRequestsListTitle: 'CHI TIẾT',
    unlockRequestsFilterStatus: 'Trạng thái',
    unlockRequestsStatusPending: 'Chờ xác nhận',
    unlockRequestsStatusApproved: 'Đã mở khóa',
    unlockRequestsStatusRejected: 'Đã từ chối',
    unlockRequestsColDate: 'NGÀY CÔNG',
    unlockRequestsColDept: 'ĐƠN VỊ',
    unlockRequestsColHead: 'TRƯỞNG ĐƠN VỊ',
    unlockRequestsColReason: 'LÝ DO',
    unlockRequestsColStatus: 'TRẠNG THÁI',
    unlockRequestsColTime: 'GỬI LÚC',
    unlockRequestsApprove: 'Xác nhận',
    unlockRequestsReject: 'Từ chối',
    unlockRequestsActionsMenu: 'Thao tác',
    unlockRequestsActionsMenuAria: 'Thao tác yêu cầu mở khóa',
    unlockRequestsRejectTitle: 'Từ chối yêu cầu mở khóa',
    unlockRequestsRejectHint: 'Có thể ghi lý do từ chối (không bắt buộc).',
    unlockRequestsRejectPlaceholder: 'Lý do từ chối...',
    unlockRequestsEmpty: 'Không có yêu cầu.',
    unlockRequestsApproveSuccess: 'Đã mở khóa ngày công cho Trưởng đơn vị.',
    unlockRequestsRejectSuccess: 'Đã từ chối yêu cầu mở khóa.',
    deptDetailApproveUnlockRequest: 'Xác nhận yêu cầu',
    deptDetailUnlock: 'Mở khóa ngày',
    deptDetailRelock: 'Thu hồi mở khóa',
    ...
    fillTimesHint:
      'Chỉ nhập ô đang trống trong 4 mốc. Giờ máy không bị ghi đè. Cần có giải trình của Trưởng đơn vị trước khi điền. Nếu hướng nghỉ trực, hệ thống chỉ bổ sung giờ lương — không tự gán Đi làm.',
    fillTimesHeadReasonTitle: 'Giải trình của Trưởng đơn vị',
    fillTimesHeadReasonIntent: 'Hướng xử lý',
    fillTimesHeadReasonText: 'Lý do thiếu giờ',
    fillTimesHeadReasonMissing: 'Trưởng đơn vị chưa giải trình — không thể điền giờ.',
  ...
  nav: {
    ...
    attendanceAuditLog: 'Lịch sử Chấm công',
    unlockRequests: 'Yêu cầu mở khóa',
    settings: 'Cài đặt',
  ...
  fingerprintTokens: {
    ...
    actionsMenuAria: 'Mở menu thao tác token kiosk',
    agentOnline: 'Online',
    ...
    mobile: {
      listTitle: (count) => `Danh sách token (${count})`,
      fieldToken: 'Token',
      fieldPin: 'PIN đăng ký',
      fieldCreated: 'Ngày tạo',
      fieldAgent: 'Agent',
    },
  },
