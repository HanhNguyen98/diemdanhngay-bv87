...
export default function ClinicalFlowPanel() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 w-[min(calc(100dvw-2rem),400px)] h-[min(85dvh,640px)] flex flex-col rounded-2xl shadow-2xl border border-gray-200 bg-white overflow-hidden max-lg:bottom-20">
